...
class Brands extends Simpla
{
    ...
    public function get_brands($filter = array())
    {
        ...
        // Выбираем все бренды
        $query = $this->db->placehold("SELECT DISTINCT b.id, b.name, b.url, b.meta_title, b.meta_keywords, b.meta_description, b.description, b.image, b.label_new, b.visible_is_main
										FROM __brands b
											$category_id_filter
											$visible_is_main_filter
											$label_new_filter
    ...
    public function get_brand($id)
    {
        ...
        $query = $this->db->placehold("SELECT b.id, b.name, b.url, b.meta_title, b.meta_keywords, b.meta_description, b.description, b.image, b.label_new, b.visible_is_main
										FROM __brands b
										WHERE $filter
										LIMIT 1");
        $this->db->query($query);
