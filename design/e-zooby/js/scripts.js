...
$(document).ready(function () {
  ...
  // МАССИВ ТОВАРОВ ДЛЯ ДОБАВЛЕНИЯ В КОРЗИНУ

//   $(document).on("submit", ".js-cart-basket-submit-array", function (e) {
//     e.preventDefault();
...
// 	var variant_ids = $('.variant_array_ids');
// 	variant_ids.each(function(event){
// 		console.log(event);
// 	});
