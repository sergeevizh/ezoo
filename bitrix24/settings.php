...
// or
define('C_REST_WEB_HOOK_URL','https://b24-q7c90w.bitrix24.by/rest/6/6ibsndix0e93ytxn/');//url on creat Webhook
...
define('C_REST_LOGS_DIR', $_SERVER['DOCUMENT_ROOT'].'/bitrix24/logs/'); //directory path to save the log
